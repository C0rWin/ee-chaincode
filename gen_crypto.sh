...
docker run --rm -v $ARTIFICATS_OUT/crypto:/export nginx openssl ecparam -name prime256v1 -genkey -noout -out "/export/CA/ca.key"
...
docker run --rm -v $ARTIFICATS_OUT/crypto:/export nginx openssl ecparam -name prime256v1 -genkey -noout -out "/export/extcc.key"
